...
GO
/****** Object:  Login [ICKRAIX\SQLServer2005MSSQLUser$ICKRAIX$SQLEXPRESS]    Script Date: 09/22/2007 16:20:18 ******/
IF  EXISTS (SELECT * FROM sys.server_principals WHERE name = N'ICKRAIX\SQLServer2005MSSQLUser$ICKRAIX$SQLEXPRESS')
DROP LOGIN [ICKRAIX\SQLServer2005MSSQLUser$ICKRAIX$SQLEXPRESS]
GO
...
GO
/****** Object:  Login [ICKRAIX\SQLServer2005MSSQLUser$ICKRAIX$SQLEXPRESS]    Script Date: 09/22/2007 16:20:18 ******/
IF NOT EXISTS (SELECT * FROM sys.server_principals WHERE name = N'ICKRAIX\SQLServer2005MSSQLUser$ICKRAIX$SQLEXPRESS')
CREATE LOGIN [ICKRAIX\SQLServer2005MSSQLUser$ICKRAIX$SQLEXPRESS] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [BUILTIN\Users]    Script Date: 09/22/2007 16:20:18 ******/

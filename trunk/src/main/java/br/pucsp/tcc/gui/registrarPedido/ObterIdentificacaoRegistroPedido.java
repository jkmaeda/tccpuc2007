...
public class ObterIdentificacaoRegistroPedido implements
	...
	public void leituraIdentificacaoFinalizada(Identificacao identificacao) {
		...
		ClienteIndividual clienteIndividual = obterCliente(identificacao);
	...
	private ClienteIndividual obterCliente(Identificacao identificacao) {
		RepositorioCliente repositorio = new FabricaRepositorio().getRepCliente();
		ClienteIndividual clienteIndividual = repositorio.obterCliente(identificacao);
